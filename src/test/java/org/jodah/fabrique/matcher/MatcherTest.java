...
import static org.jodah.fabrique.TestUtil.assertEqualWhenReserialized;
import static org.jodah.fabrique.TestUtil.assertEqualsBothWays;
import static org.jodah.fabrique.matcher.Matchers.annotatedWith;
import static org.jodah.fabrique.matcher.Matchers.any;
import static org.jodah.fabrique.matcher.Matchers.identicalTo;
import static org.jodah.fabrique.matcher.Matchers.inPackage;
import static org.jodah.fabrique.matcher.Matchers.inSubpackage;
import static org.jodah.fabrique.matcher.Matchers.isMethod;
import static org.jodah.fabrique.matcher.Matchers.not;
import static org.jodah.fabrique.matcher.Matchers.only;
import static org.jodah.fabrique.matcher.Matchers.returns;
import static org.jodah.fabrique.matcher.Matchers.subclassesOf;
...
import org.jodah.fabrique.matcher.Matchers;
...
public class MatcherTest {
  ...
  public void testInPackage() {
    ...
    assertEquals("inPackage(org.jodah.fabrique.matcher)", inPackage(matchersPackage)
        .toString());
