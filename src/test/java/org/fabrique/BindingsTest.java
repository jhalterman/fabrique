...
public class BindingsTest {
	...
	private void assertBinding(Class<?> pBoundType, String pName, Class pTarget,
		...
		if (pProviderInstance == null) {
			...
			assertEquals("Binding provider was not as expected",
					pProviderInstance.get().getClass(), _provider.get().getClass());
		}
	}
	...
	private void assertEagerSingleton(Binding<?> pBinding) {
		...
		assertEquals("Eager singleton scoped binding does not produce identical instances",
				_instance1, _intsance2);
	}
